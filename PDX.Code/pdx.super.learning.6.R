...
pdx.super.learning.6 = function(cancer.type, outcome, gene.data.file, numgenes, input_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', output_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', k = 5, seed = 1, strip = T, outstring = "_sl6.csv"){
