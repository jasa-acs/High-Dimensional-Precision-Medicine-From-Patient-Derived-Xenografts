...
pdx.ql.rf1.smooth.final = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, c1, c2, k = 5, seed = 1, strip = T, outstring = "_qlrf1smooth.coefs.csv") {
...
}  # end pdx.ql.rf1.smooth function
