# pdx.ql.rf1.smooth.eval.R

# Q-learning with random forests and random forest smoothed outcomes, no pseudo-values
...
pdx.ql.rf1.smooth.eval = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, k = 5, seed = 1, strip = T, outstring = "_qlrf1smooth.csv") {
