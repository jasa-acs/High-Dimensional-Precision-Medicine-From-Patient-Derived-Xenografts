...
source("~/PDX/pdx.ql.rf1.eval.R")
source("~/PDX/pdx.ql.rf2.eval.R")
source("~/PDX/pdx.ql1.eval.R")
source("~/PDX/pdx.ql2.eval.R")
...
pdx.super.learning.16 = function(cancer.type, outcome, gene.data.file1, gene.data.file2, numgenes, input_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', output_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', k = 5, seed = 1, strip = T, outstring = "_sl16.csv"){

  O1 = pdx.ql1.smooth.eval(cancer.type, outcome, gene.data.file1, numgenes, input_dir, output_dir)
  O2 = pdx.ql2.smooth.eval(cancer.type, outcome, gene.data.file1, numgenes, input_dir, output_dir)
  O3 = pdx.ql.rf1.smooth.eval(cancer.type, outcome, gene.data.file1, numgenes, input_dir, output_dir)
  O4 = pdx.ql.rf2.smooth.eval(cancer.type, outcome, gene.data.file1, numgenes, input_dir, output_dir)
  O5 = pdx.ql.rf1.eval(cancer.type, outcome, gene.data.file1, input_dir, output_dir)
  O6 = pdx.ql.rf2.eval(cancer.type, outcome, gene.data.file1, input_dir, output_dir)
  O7 = pdx.ql1.eval(cancer.type, outcome, gene.data.file1, input_dir, output_dir)
  O8 = pdx.ql2.eval(cancer.type, outcome, gene.data.file1, input_dir, output_dir)
  O9 = pdx.ql1.eval(cancer.type, outcome, gene.data.file2, input_dir, output_dir, strip = F, outstring = '_qldl1.csv')
  O10 = pdx.ql2.eval(cancer.type, outcome, gene.data.file2, input_dir, output_dir, strip = F, outstring = '_qldl2.csv')  
  O11 = pdx.ql.rf1.eval(cancer.type, outcome, gene.data.file2, input_dir, output_dir, strip = F, outstring = '_qlrfdl1.csv')
  O12 = pdx.ql.rf2.eval(cancer.type, outcome, gene.data.file2, input_dir, output_dir, strip = F, outstring = '_qlrfdl2.csv')
  O13 = pdx.ql1.smooth.eval(cancer.type, outcome, gene.data.file2, numgenes, input_dir, output_dir, strip = F, outstring = '_ql1smoothdl.csv')
  O14 = pdx.ql2.smooth.eval(cancer.type, outcome, gene.data.file2, numgenes, input_dir, output_dir, strip = F, outstring = '_ql2smoothdl.csv')
  O15 = pdx.ql.rf1.smooth.eval(cancer.type, outcome, gene.data.file2, numgenes, input_dir, output_dir, strip = F, outstring = '_qlrf1smoothdl.csv')
  O16 = pdx.ql.rf2.smooth.eval(cancer.type, outcome, gene.data.file2, numgenes, input_dir, output_dir, strip = F, outstring = '_qlrf2smoothdl.csv')
  
  O.list = list(O1, O2, O3, O4, O5, O6, O7, O8, O9, O10, O11, O12, O13, O14, O15, O16)
  J = length(O.list)
  ...
  biomarkers = read.csv(gene.data.file1)
  ...
  rownames(res) = NULL
  setwd(output_dir)
  output.name = paste(cancer.type, "_", outcome, "_", stri_sub(gene.data.file1, 1, -5), outstring, sep = "")
