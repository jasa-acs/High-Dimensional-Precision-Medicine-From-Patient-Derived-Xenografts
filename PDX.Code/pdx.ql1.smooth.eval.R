...
pdx.ql1.smooth.eval = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, k = 5, seed = 1, strip = T, outstring = "_ql1smooth.csv") {
