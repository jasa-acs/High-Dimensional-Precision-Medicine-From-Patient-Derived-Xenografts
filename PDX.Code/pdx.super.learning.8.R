...
pdx.super.learning.8 = function(cancer.type, outcome, gene.data.file, numgenes, input_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', output_dir = '/mnt/home/yzhan234/PDX/PDX.CodeAndData/super-learning', k = 5, seed = 1, strip = T, outstring = "_sl8.csv"){
  ...
  O5 = pdx.ql.rf1.eval(cancer.type, outcome, gene.data.file, input_dir, output_dir)
  O6 = pdx.ql.rf2.eval(cancer.type, outcome, gene.data.file, input_dir, output_dir)
  O7 = pdx.ql1.eval(cancer.type, outcome, gene.data.file, input_dir, output_dir)
  O8 = pdx.ql2.eval(cancer.type, outcome, gene.data.file, input_dir, output_dir)
  
  O.list = list(O1, O2, O3, O4, O5, O6, O7, O8)
  J = length(O.list)
