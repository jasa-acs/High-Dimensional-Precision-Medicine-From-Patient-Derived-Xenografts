...
# Q-learning with random forests, random forest smoothed outcomes, and pseudo-values
...
pdx.ql.rf2.smooth = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, k = 5, seed = 1, strip = T, outstring = "_qlrf2smooth.csv") {
