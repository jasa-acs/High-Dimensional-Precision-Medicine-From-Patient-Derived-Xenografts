...
pdx.owl.linear.smooth = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, c1s = c(0), c2s = NA, k = 5, seed = 1, strip = T, outstring = "_owllinearsmooth.csv") {
...
}  # end pdx.owl.linear.smooth function
