...
# numgenes is the number of genes to use for RF predicted values
...
pdx.ql1.smooth.final = function(cancer.type, outcome, gene.data.file, numgenes, input_dir, output_dir, c1, c2, k = 5, seed = 1, strip = T, outstring = "_ql1smooth.coefs.csv") {
