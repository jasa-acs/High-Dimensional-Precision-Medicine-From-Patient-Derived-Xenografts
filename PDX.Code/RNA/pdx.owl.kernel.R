# pdx.owl.kernel.new.R

# OWL with Gaussian kernel on PDX data
...
pdx.owl.kernel = function(cancer.type, outcome, gene.data.file, input_dir, output_dir, k = 5, seed = 1, strip = T, outstring = "_owlkernel.csv") {
